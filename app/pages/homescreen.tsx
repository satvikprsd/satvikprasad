...
export default function HomeScreen(){
    return (
        <div className="grid h-screen min-w-[350px] min-h-[700px] grid-cols-12 grid-rows-10 gap-4 p-4 max-lg:h-auto max-lg:grid-rows-none max-lg:py-6 transition-all duration-300 ease-in-out">
            <Loader />
            ...
            <div className="col-span-4 row-span-8 min-w-[320px] max-lg:col-span-full"><TerminalPortfolio /></div>
